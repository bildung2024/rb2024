...
var labelVizCluster = containerTitle.children.push(am5.Label.new(root, {
  ...
  fill: ColorBlackYAxisText,
  cursorOverStyle: "pointer",
  tooltip: tooltipNetworkViz,
  // tooltipText: "[fontWeight: 500 fontSize: 12px #fff]Visualisierung Themen Cluster anzeigen[fontSize: 7px] [fontSize: 12px]/[fontSize: 7px] [fontWeight: 500 fontSize: 12px]verbergen",
  tooltipText: "[fontWeight: 500 fontSize: 12px #fff]Visualisierung Themen Cluster",
...
var labelVizNetwork = containerTitle.children.push(am5.Label.new(root, {
  ...
  cursorOverStyle: "pointer",
  tooltip: tooltipNetworkViz,
  //tooltipText: "[fontWeight: 500 fontSize: 12px #fff]Visualisierung Netzwerk anzeigen[fontSize: 7px] [fontSize: 12px]/[fontSize: 7px] [fontWeight: 500 fontSize: 12px]verbergen",
  tooltipText: "[fontWeight: 500 fontSize: 12px #fff]Visualisierung der Vernetzung\nInvite & MeinBildungsraum",
...
labelVizCluster.events.on("click", function (ev) {
  vizClusterStatus = document.getElementById('vizcluster').style.display;
  console.log("status:" + vizClusterStatus);

  if (vizClusterStatus == 'none') {
    document.getElementById('vizcluster').style.display = 'inline-block';
  }
  else {
    document.getElementById('vizcluster').style.display = 'none';
  }
});

labelVizNetwork.events.on("click", function (ev) {
  vizNetworkStatus = document.getElementById('viznetwork').style.display;
  if (vizNetworkStatus == 'none') {
    document.getElementById('viznetwork').style.display = 'inline-block';
  }
  else {
    document.getElementById('viznetwork').style.display = 'none';
  }
});
